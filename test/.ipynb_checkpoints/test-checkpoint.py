...
#======================================================================================
path_imgs = '/netscratch/devidas/hlcv3/DIV2K_LR/x4/test_x4'
test_hr = '/netscratch/devidas/hlcv3/DIV2K_HR/test_HR'
local_path = "/netscratch/devidas/hlcv3/test"
test_fol = ['patch_lr','patch_hr']

csv_dir = '/netscratch/devidas/hlcv3/csv_output'
saved_weights_dir = '/netscratch/devidas/hlcv3/saved_weights'
output_dir = '/netscratch/devidas/hlcv3/train_output'

test_patch_lr = '/netscratch/devidas/hlcv3/test/patch_lr'
test_patch_hr = '/netscratch/devidas/hlcv3/test/patch_hr'

test_input_dir = '/netscratch/devidas/hlcv3/test/test_img_lr'
test_output_dir = '/netscratch/devidas/hlcv3/test/test_gen_hr'
test_label_dir = '/netscratch/devidas/hlcv3/test/test_label_hr'
test_ip_lbl_compare_dir = '/netscratch/devidas/hlcv3/test/test_compare_output'
#test_metrics = '/content/gdrive/MyDrive/HLCV/HLCV_project/test/test_metrics'
